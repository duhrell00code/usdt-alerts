...
# rAIX Subscription Vault (mainnet)
RAIX_VAULT_ACCOUNT_ID = os.getenv("RAIX_VAULT_ACCOUNT_ID")
RAIX_CONTRACT_ADDRESS = os.getenv("RAIX_CONTRACT_ADDRESS", "").lower() or None

# rAIX Redemption Vault (mainnet) — RAIX_REDEMPTION_ASSET_ID optional until token is minted
RAIX_REDEMPTION_VAULT_ACCOUNT_ID = os.getenv("RAIX_REDEMPTION_VAULT_ACCOUNT_ID")
RAIX_REDEMPTION_ASSET_ID = os.getenv("RAIX_REDEMPTION_ASSET_ID")
RAIX_REDEMPTION_CONTRACT_ADDRESS = os.getenv("RAIX_REDEMPTION_CONTRACT_ADDRESS", "").lower() or None
...
for name, val in [
    ...
    ("RAIX_VAULT_ACCOUNT_ID", RAIX_VAULT_ACCOUNT_ID),
    ("RAIX_REDEMPTION_VAULT_ACCOUNT_ID", RAIX_REDEMPTION_VAULT_ACCOUNT_ID),
