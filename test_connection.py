import time
from config import FIREBLOCKS_API_KEY, FIREBLOCKS_PRIVATE_KEY_PATH, VAULT_ACCOUNT_ID, ASSET_ID
...
txs = get_incoming_transactions(sdk, VAULT_ACCOUNT_ID, ASSET_ID, int(time.time() * 1000) - 86400000)
